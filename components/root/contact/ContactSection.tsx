                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 lg:space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 lg:px-4 py-2.5 lg:py-3 border rounded-lg bg-gray-50 transition-colors text-sm lg:text-base focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent ${errors.full_name ? 'border-red-500' : 'border-gray-200'
                                        }`}
                                />
                                {errors.full_name && (
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 lg:px-4 py-2.5 lg:py-3 border rounded-lg bg-gray-50 transition-colors text-sm lg:text-base focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent ${errors.email ? 'border-red-500' : 'border-gray-200'
                                        }`}
                                />
                                {errors.email && (
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 lg:px-4 py-2.5 lg:py-3 border rounded-lg bg-gray-50 transition-colors text-sm lg:text-base focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent ${errors.organization ? 'border-red-500' : 'border-gray-200'
                                        }`}
                                />
                                {errors.organization && (
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className={`w-full px-3 lg:px-4 py-2.5 lg:py-3 border rounded-lg bg-gray-50 resize-none transition-colors text-sm lg:text-base focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent ${errors.message ? 'border-red-500' : 'border-gray-200'
                                        }`}
                                />
                                {errors.message && (
                            ...
                            <button
                                type="submit"
                                disabled={isPending}
                                className="w-full bg-primary cursor-pointer text-white py-3 px-6 rounded-lg font-medium transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 active:translate-y-0 text-sm lg:text-base disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                            >
