                ...
                <DialogContent className="sm:max-w-3xl bg-gray-50">
                    ...
                    <div className="flex gap-4 mt-8 pt-6">
                        <button
                            ...
                            className="flex-1 px-6 py-3 border border-gray-300 rounded-lg text-primary hover:bg-gray-100 transition-colors"
                        >
                            Close
                        </button>
                        <button
                            onClick={() => handleExportLog(selectedLog)}
                            className="flex-1 px-6 py-3 bg-primary text-white rounded-lg hover:bg-primary transition-colors"
                        >
                            Export log
                        </button>
                    </div>
